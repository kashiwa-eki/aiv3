...
train_file = data_path + "/train2.txt"
test_file = data_path + "/test2.txt"
pickle_file = data_path + "/tokenizer2.pickle"
model_file = data_path + "/lstm2.h5"
...
if args.run_opt == 1:
    ...
    model.fit(X_train, y_train, validation_split=0.1, batch_size=32, epochs=40, verbose=2)
